...
// export default function NewUser({ setShowModal, isUpdate, functioncall, name, email, phone, enroll, admission, setname, setemail, setphone, setenroll, setadmission, updateuserid })
//  {
...
//                             id="user_Id" name="" type="" class="w-full py-3 border border-slate-200 rounded-lg px-3 focus:outline-none focus:border-slate-500 hover:shadow" placeholder="Enter your userId" ></input>
//                         </label>
//                     <label for="name">
//                             <p class="font-medium text-slate-700 pb-2">Name </p>
//                             <input onChange={(e)=>setname(e.target.value)}
//                              id="user_Name" name="name" type="name" class="w-full py-3 border border-slate-200 rounded-lg px-3 focus:outline-none focus:border-slate-500 hover:shadow" placeholder="Enter your name " ></input>
//                         </label>
//                    <label for="e_mail">
...
//                             id="e_mail" name="e_mail" type="email" class="w-full py-3 border border-slate-200 rounded-lg px-3 focus:outline-none focus:border-slate-500 hover:shadow" placeholder="Enter your email " ></input>
//                         </label>
...
//                             id="ph_no" name="ph_no" type="number" class="w-full py-3 border border-slate-200 rounded-lg px-3 focus:outline-none focus:border-slate-500 hover:shadow" placeholder="Enter your phonenumber" ></input>
//                         </label>
...
//                             id="e_no" name="e_no" type="string" class="w-full py-3 border border-slate-200 rounded-lg px-3 focus:outline-none focus:border-slate-500 hover:shadow" placeholder="Enter your enrollnumber" ></input>
//                         </label>
//                         <label for="d_oa">
...
//                              id="d_oa" name="d_oa" type="date" class="w-full py-3 border border-slate-200 rounded-lg px-3 focus:outline-none focus:border-slate-500 hover:shadow" placeholder="Enter your date" ></input>
//                         </label>
//                         </div>
//                         <button 
//                         onClick={(e) => {
...
//                             }
//                         }}
//                         className="w-full py-3 font-medium text-white bg-yellow-400 hover:shadow inline-flex space-x-2 items-center justify-center" >
...
// // import { useNavigate } from 'react-router-dom';
// // import { UpdateForm } from '../components/userslist';
...
// //             <label for="">
// //                     <p class="font-medium text-slate-700 pb-2">UserId</p>
// //                     <input onChange={(e)=>setid(e.target.value)} id="user_Id" name="" type="" class="w-full py-3 border border-slate-200 rounded-lg px-3 focus:outline-none focus:border-slate-500 hover:shadow" placeholder="Enter your userId" value={user_Id}></input>
// //                 </label>
// //             <label for="name">
// //                     <p class="font-medium text-slate-700 pb-2">Name </p>
...
// //            <label for="e_mail">
// //                     <p class="font-medium text-slate-700 pb-2">Email </p>
// //                     <input onChange={(e)=>setmail(e.target.value)} id="e_mail" name="e_mail" type="email" class="w-full py-3 border border-slate-200 rounded-lg px-3 focus:outline-none focus:border-slate-500 hover:shadow" placeholder="Enter your email " value={e_mail}></input>
// //                 </label>
...
// //        {/* //{modal? <UpdateForm idd={"person.userId}"} namee={"person.userName"} eemail={"person.email"} ppass={"person.password"} phh={"person.phone"}  eeno={"person.eno"} ddoa={"person.doa}"}/> : null} */}
// //         </div>
// //     )
// // }